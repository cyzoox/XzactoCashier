...
function DrawerScreen({ store_info }) {
  return (
    <Drawer.Navigator
      ...
      drawerContent={(props) => (
        <DrawerContent initialParams={{ store_info: store_info }} {...props} />
      )}
    >
      <Drawer.Screen
        name="Home"
      ...
      <Drawer.Screen
        initialParams={{ store_info: store_info }}
        name="BarcodePageCheckout"
        component={BarcodeCheckoutScreen}
      />
    </Drawer.Navigator>
  );
}
  ...
  return (
    <Stack.Navigator>
      <Stack.Screen
        ...
        options={{ headerShown: false }}
      />
      <Stack.Screen name="Storeboard" options={{ headerShown: false }}>
        {(props) => {
          const { navigation, route } = props;
          const { store_info } = route.params;
          return <DrawerScreen store_info={store_info} />;
        }}
      </Stack.Screen>
    </Stack.Navigator>
  );
